<template>
  <div class="home">
    ...
    <!-- Burasıtarifler kısmını gösterip alltaki link ile o tarife gidebileceğimiz bir alan  -->
    <div class="recipes">
      <!-- Recipes to go here  -->
    ...
    <!-- Eğer pencere açıksa burdaki form elemanlarını göster demiş oluyoruz -->
    <div class="add-recipe-popup" v-if="popupOpen">
      <div class="popup-content">
        ...
        <form @submit.prevent="addNewRecipe">
          ...
          <!-- Yeni bir malzeme girişi için input alanı olusturma  -->
          <div class="group">
          ...
          <div class="group">
            <label>Methods</label>
            <div class="method" v-for="item in newRecipe.methodRows" :key="item">
...
export default {
  ...
  setup() {
    ...
    //popoup içerisinin butona basılınca açılıp kapanmasını ayarladığımız yer     
    const togglePopup = () => {
      popupOpen.value = !popupOpen.value;
    }

    //ben yapılacaklar yolunu adım adım gösterebilmek için sütun ekliyorum
    ...
    //  eklenecek olan yeni tarifin başlıgındaki boşluklar arasında tire oluşturmayı sağlıyor 
    //yazılacak yazılar küçük harf olacağı belirtilmiştir.
    const addNewRecipe = () => {
      ...
      //{...newRecipe.value}, yeni bir tarif objesinin bir kopyasını oluşturur. Bu obje, formdaki girişlerden alınır ve yeni bir tarif oluşturmak için kullanılır.
